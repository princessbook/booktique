    ...
    <div
      ...
      <div className='bg-white rounded-t-2xl py-3 mt-2'>
        ...
        <div
          ...
          style={{
            WebkitOverflowScrolling: 'touch', // 사파리에서 스크롤을 원활하게 동작하도록 설정
            overflowX: 'auto', // 가로 스크롤이 필요한 경우에만 스크롤을 표시
            scrollbarWidth: 'none', // 사파리 브라우저의 스크롤바를 숨깁니다
            msOverflowStyle: 'none' // Internet Explorer용 스크롤바를 숨깁니다
          }}>
